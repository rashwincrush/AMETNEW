...
const TermsPage = () => {
  return (
    <div className="container mx-auto p-6 bg-white shadow-lg rounded-lg">
      <h1 className="text-3xl font-bold mb-6 text-center">Alumni Association - Terms and Conditions</h1>
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal list-inside text-gray-700 space-y-2">
          <li>To strengthen alumni engagement with the University and support its academic, cultural, and extracurricular growth.</li>
          ...
          <li>To protect the collective interests of alumni while upholding the values of the institution.</li>
        </ol>
      </section>
